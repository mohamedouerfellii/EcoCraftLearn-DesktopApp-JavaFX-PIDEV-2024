...
public class PtsCollectMainPageController implements Initializable {
    ...
    public void addNewCollectionpt() {
        if (newCollectionPtsAdress.getText().isEmpty() || newCollectionPtsCapacity.getText().isEmpty() || newCollectionptsName.getText().isEmpty()) {
    ...
    public void UpdateCollectionpt(CollectionPoint entity) {
        ...
        if (updateCollectionPtsCapacity.getText().isEmpty() || updateCollectionPtsAdress.getText().isEmpty() || updateCollectionptsName.getText().isEmpty()) {
            Alert alert = new Alert(Alert.AlertType.ERROR);
            alert.setTitle("Error");
            alert.setHeaderText(null);
            alert.setContentText("Veuillez remplir tous les champs");
