...
public class HomePageController implements Initializable {
    ...
    @FXML
    public void eventsBtnClicked(MouseEvent event){
        eventsBtn.setStyle(styleMenuBtnClicked);
        eventsBtnImg.setImage(new Image("/icons/dark/calendar-event-line.png"));
        ...
        } else if(coursesBtn.getStyle().equals(styleMenuBtnClicked)){
        ...
        try{
            FXMLLoader fxmlLoader = new FXMLLoader();
            fxmlLoader.setLocation(getClass().getResource("/gui/students/EventPage.fxml"));
            Parent root = fxmlLoader.load();
