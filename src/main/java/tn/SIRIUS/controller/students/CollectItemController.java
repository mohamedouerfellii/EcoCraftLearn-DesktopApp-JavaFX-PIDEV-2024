...
public class CollectItemController {
    ...
    public void setCollectItemData(Collect Collect) {
        ...
        updateCollectBtn.setOnAction(e->{
            ptsCollectMainPageController.recoverCollect(Collect);
            ptsCollectMainPageController.getUpdateCollectContainer().setVisible(true);
            ptsCollectMainPageController.getUpdateCollectBtn().setOnAction(e1->{
                ptsCollectMainPageController.updateCollect(Collect);
            });
        });
